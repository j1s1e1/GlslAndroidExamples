...
public class Tut_MeshTransforms extends TutorialBase {
    ...
    ProgramData LoadProgram(String strVertexShader, String strFragmentShader)
    {
        ...
        if (data.positionAttribute != -1)
        {
            ...
            {
                Log.i("Load Program", "These meshes only work with position at location 0 " + strVertexShader);
            }
        }
        if (data.colorAttribute != -1)
        {
            if (data.colorAttribute != 1)
            {
                Log.i("Load Program", "These meshes only work with color at location 1" + strVertexShader);
            }
        }
    ...
    protected void init() throws Exception
    {
        ...
        try
        {
            ...
            g_pInfinityMesh = new Mesh("infinity.xml");
